	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
			...
			<c:forEach items="${requestScope.jobs}" var="job" varStatus="stat">
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${job.id}"></td>
					 <td>${job.name }</td>
					  <td>${job.remark }</td>
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/job/findJobById?id=${job.id}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
		  <yyf:pager
				  ...
				  submitUrl="${pageContext.request.contextPath}/job/fingJob?pageIndex={0}&name=${name}"/>
<%--	  	 <fkjava:pager--%>
